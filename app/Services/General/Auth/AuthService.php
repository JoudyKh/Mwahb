...
class AuthService
{
    ...
    public function resetEmail(ResetEmailRequest $request): true
    {
        ...
        if (Carbon::parse($code->expired_at)->isPast()) {
            throw new Exception(__('messages.expired_verification_code'), 422);
        }
    ...
    public function sendVerificationCode(SendVerificationCodeRequest &$request): true
    {
        return DB::transaction(function () use ($request) {
            ...
            $details = [
                'subject' => __('messages.verification_code_body_type'),
                'title' => __('messages.your_verification_code_is'),
                'code' => $code,
                'body_type' => __('messages.verification_code_body_type'),
                'body' => __('messages.verification_code_body'),
                'footer' => __('messages.verification_code_footer'),
            ];
