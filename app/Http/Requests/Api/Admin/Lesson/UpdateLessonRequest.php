 ...
 *     @OA\Property(property="video_file", type="string", format="binary", description="File of the lesson video"),
 *     @OA\Property(property="trashed_files[0]", type="integer", description="File to delete"),
 *     @OA\Property(property="trashed_files[1]", type="integer", description="File to delete"),
 *     @OA\Property(property="files[0]",type="string", format="binary", description="File"),
 *     @OA\Property(property="files[1]", type="string", format="binary", description="File"),
 *     @OA\Property(
 *         property="exam_id",
 *         type="integer",
 *         nullable=true,
 ...
 *     ),
 *     @OA\Property(
 *         property="lesson_order_replacement_id",
 *         type="integer",
 *         description="lesson order replacement id"
 *     ),
 *     @OA\Property(
 *         property="exam",
 *         type="array",
