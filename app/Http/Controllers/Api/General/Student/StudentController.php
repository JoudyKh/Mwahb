...
class StudentController extends Controller
{
    ...
    public function show(User $student)
    {
        ...
        try {
            ...
            $statistecs = StudentExamService::statistics($student->id, 'ASC', false)->getData();

            $student->total_avg = $statistecs->total_avg;
            $student->solved_exams_count = $statistecs->success_count;
            $student->failed_exams_count = $statistecs->faileure_count;

            return success(StudentResource::make($student->loadMissing(['images'])), 200, $extraData);
        } catch (\Throwable $th) {
