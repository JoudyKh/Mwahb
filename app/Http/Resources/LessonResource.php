 ...
 *     @OA\Property(property="video_file", type="string", format="uri", description="URL of the lesson video", example="https://example.com/video.mp4"),
...
class LessonResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $response = [
            ...
            'files' => $this->when(
                $user?->hasRole(Constants::ADMIN_ROLE) ||$user?->hasRole(Constants::SUPER_ADMIN_ROLE) || app()->bound('allow_video_and_files'),
                fn () => $this->whenLoaded('files', fn() => FileResource::collection($this->files), [])
            ),
        ...
        $response['video_streams'] = $this->video_streams;
