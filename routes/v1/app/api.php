...
use App\Http\Controllers\Api\General\Course\CoursePurchaseController;
...
Route::group(['middleware' => ['auth:api', 'last.active']], function () {
    ...
    Route::prefix('courses')->group(function () {
        Route::post('/buy/otp', [CoursePurchaseController::class, 'sendSyriatelCashOTP']);
        Route::post('/buy/otp/check', [CoursePurchaseController::class, 'checkSyriatelCashOTP']);
        Route::post('/buy/otp/resend', [CoursePurchaseController::class, 'resendSyriatelCashOTP']);
    });
});
