...
-- ALTER TABLE `coupons` CHANGE `discount_percentage` `amount` DOUBLE NOT NULL;
-- ALTER TABLE `coupons` ADD `type` VARCHAR(255) NOT NULL DEFAULT 'percentage' AFTER `usage_limit`;
-- ALTER TABLE `subscription_requests` CHANGE `image` `image` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;

-- ALTER TABLE `coupons` CHANGE `expires_at` `expires_at` DATE NOT NULL;
-- ALTER TABLE `contact_messages` CHANGE `email` `email` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;

-- INSERT INTO `infos` (`id`, `super_key`, `key`, `value`, `created_at`, `updated_at`) VALUES
-- (NULL, 'about_us', 'description', NULL, NULL, NULL),
-- (NULL, 'about_us', 'image', NULL, NULL, NULL),
-- (NULL, 'contact', 'linkedin', NULL, NULL, NULL)

-- ALTER TABLE `lessons` ADD `video_file` VARCHAR(255) NULL DEFAULT NULL AFTER `video_url`;
-- ALTER TABLE `lessons` CHANGE `video_url` `video_url` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;

INSERT INTO `infos` (`id`, `super_key`, `key`, `value`, `created_at`, `updated_at`) VALUES (NULL, 'hero', 'image', NULL, NULL, NULL)
